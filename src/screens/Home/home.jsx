...
const Home = () => {
  ...
  const handleButtonClick = () => {
    navigate('/#logincards'); // Navigate to the route with hash fragment
  };

  return (
    <div>
      <Header onLoginClick={handleButtonClick}  />
      <Banner />
      {/* You can add more sections or content here */}

      {/* Card Section */}
      <div className="cards-container" id='logincards'>
        <div className="card">
        ...
        <div className="card">
          ...
          <div className="card-buttons">
            <button className="btn">
              <Link to = "/legal-aid-login"> Login as Legal Aid Provider </Link>
        ...
        <div className="card">
          ...
          <div className="card-buttons">
            <button className="btn">
              <Link to="/aboutUs">General Info</Link>
